...
do -- ESP Functions
    function ESP:Player(Instance, Data)
        ...
        Components.Name = Framework:Draw("Text", {Text = Instance.Name, Font = 1, Size = 13, Outline = true, Center = true})
        Components.NameBold = Framework:Draw("Text", {Text = Instance.Name, Font = 1, Size = 13, Center = true})
        Components.Distance = Framework:Draw("Text", {Font = 1, Size = 13, Outline = true, Center = true})
        Components.DistanceBold = Framework:Draw("Text", {Font = 1, Size = 13, Center = true})
        Components.Tool = Framework:Draw("Text", {Font = 1, Size = 13, Outline = true, Center = true})
        Components.ToolBold = Framework:Draw("Text", {Font = 1, Size = 13, Center = true})
        Components.Health = Framework:Draw("Text", {Font = 1, Size = 13, Outline = true, Center = true})
        Components.HealthBold = Framework:Draw("Text", {Font = 1, Size = 13, Center = true})
    ...
    function ESP:Object(Instance, Data)
        ...
        local Components = Object.Components
        Components.Name = Framework:Draw("Text", {Text = Object.Name, Color = col, Font = 1, Size = 13, Outline = out, Center = true, Transparency = trans})
        Components.Addition = Framework:Draw("Text", {Text = Object.Addition.Text, Color = Object.Addition.Color, Font = 1, Size = 13, Outline = out, Center = true, Transparency = trans})
        self.Objects[Instance] = Object
        return Object
    end
end
