...
do -- ESP Functions
    function ESP:Player(Instance, Data)
        ...
        Components.Name = Framework:Draw("Text", {Text = Instance.Name, font = 4, Size = 14, Outline = true, Center = true})
        Components.NameBold = Framework:Draw("Text", {Text = Instance.Name, font = 4, Size = 14, Center = true})
        Components.Distance = Framework:Draw("Text", {font = 4, Size = 14, Outline = true, Center = true})
        Components.DistanceBold = Framework:Draw("Text", {font = 4, Size = 14, Center = true})
        Components.Tool = Framework:Draw("Text", {font = 4, Size = 14, Outline = true, Center = true})
        Components.ToolBold = Framework:Draw("Text", {font = 4, Size = 14, Center = true})
        Components.Health = Framework:Draw("Text", {font = 4, Size = 14, Outline = true, Center = true})
        Components.HealthBold = Framework:Draw("Text", {font = 4, Size = 14, Center = true})
