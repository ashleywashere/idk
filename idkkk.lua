...
do -- ESP Functions
    function ESP:Player(Instance, Data)
        ...
        Components.Name = Framework:Draw("Text", {Text = Instance.Name, font = 4, Size = 14.5, Outline = true, Center = true})
        Components.NameBold = Framework:Draw("Text", {Text = Instance.Name, font = 4, Size = 14.5, Center = true})
        Components.Distance = Framework:Draw("Text", {font = 4, Size = 14.5, Outline = true, Center = true})
        Components.DistanceBold = Framework:Draw("Text", {font = 4, Size = 14.5, Center = true})
        Components.Tool = Framework:Draw("Text", {font = 4, Size = 14.5, Outline = true, Center = true})
        Components.ToolBold = Framework:Draw("Text", {font = 4, Size = 14.5, Center = true})
        Components.Health = Framework:Draw("Text", {font = 4, Size = 14.5, Outline = true, Center = true})
        Components.HealthBold = Framework:Draw("Text", {font = 4, Size = 14.5, Center = true})
    ...
    function ESP:Object(Instance, Data)
        ...
        local Components = Object.Components
        Components.Name = Framework:Draw("Text", {Text = Object.Name, Color = col, font = 4, Size = 14, Outline = out, Center = true, Transparency = trans})
        Components.Addition = Framework:Draw("Text", {Text = Object.Addition.Text, Color = Object.Addition.Color, font = 4, Size = 14, Outline = out, Center = true, Transparency = trans})
        self.Objects[Instance] = Object
        return Object
    end
end
